...
def get_satids( db ):
    ...
    dc.execute( 'SELECT id_patmos FROM "patmos.ftp.2015-04-14"' )
    ids = dc.fetchall()
...
def main():
    ...
    """
    Print all the PATMOS coefficients from the FTP server; they are
    probably from the year 2013, at least most of them. The file dates
    indicate the coefficient files have been uploaded in 2015.
    """
